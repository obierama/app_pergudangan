...
public class lap_barang_keluar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LAPORAN DATA BARANG KELUAR");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            File report = new File("src/barang_keluar.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lap_barang_keluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lap_barang_keluar().setVisible(true);
            }
        });
    }
