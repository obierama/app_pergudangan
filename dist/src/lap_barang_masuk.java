...
public class lap_barang_masuk extends javax.swing.JFrame {

    private DefaultTableModel tabmode;
    
    private void tampil_data() {
        Object[]baris = {"Id", "Tanggal Masuk", "Id Supplier", "Nama Supplier", "PIC", "Id Pemesanan", "Tanggal_Pemesanan", "Kode Barang", "Nama Barang", "Harga", "Jumlah"};
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LAPORAN DATA BARANG MASUK");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            File report = new File("src/barang_masuk.jrxml");
            jasDes = JRXmlLoader.load(report);
            //nama.clear();
            nama.put("id",jComboBox1.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lap_barang_masuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
